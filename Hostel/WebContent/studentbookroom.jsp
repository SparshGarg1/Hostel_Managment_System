...
<div class="main">
    ...
    <div class="contain">
        <p class="head">Hostel Booking</p>
        <form action="StudentAppoinmentSubmit?email=<%=email %>" method="post">
        <div class="bo">
            <p>Full Name</p>
            <div>
        ...
        <label for="room" class="bo">Choose a Room:</label>
            <select id="room" name="room" >
            <%
            	String qr1 = "select * from room";
